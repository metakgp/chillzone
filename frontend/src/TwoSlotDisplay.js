...
import LearnMoreContent from "./LearnMoreContent.js";
  ...
  render() {
    ...
    return (
      <div className="container">
        ...
        <p>
          The empty classes listed below might not be accurate in real life.
          <a onClick={() => this.setState({ showLearnMoreContent: !this.state.showLearnMoreContent })}>
            Learn More
          </a>
        </p>
        {this.state.showLearnMoreContent && <LearnMoreContent />}
